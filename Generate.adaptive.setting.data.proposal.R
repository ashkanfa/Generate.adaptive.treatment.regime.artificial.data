...
cov.data_wcor<-list("cov"=cov.data,"cov correlation"=cor(cov.data))

return(list("cov"=cov.data_wcor,"trt"=trt ,"y"=y,"t.state"=t.state,"True.outcome"=True.outcome,"True.treatment"=True.treatment))
}
